...
d3.json("http://localhost:9090/dataid/CreateD3JSONFormat2?dataset=http://gerbil.aksw.org/gerbil/dataId/corpora/N3-Reuters-128%23dataset&level=1", function(json) {
data = json;
console.log(data);
