...
public class Queries {
	...
	public static ArrayList<String> getMongoDBObject(String collectionName,
	...
	//
	// str = str +
	// "<table><tr><th style=\"width:570px\">DownloadURL</th><th style=\"margin-left:15px\">Status</th></tr>";
	// for (DBObject instance : instances) {
	// str = str + "<tr><td>";
	// str = str +
	// instance.get(DistributionMongoDBObject.DOWNLOAD_URL).toString();
	// str = str + "</td><td>";
	// str = str +
	// "<span style=\"color:green\"> "+instance.get(DistributionMongoDBObject.STATUS).toString()+"</span>";
	// // str = str + "</td><td>";
	// //
	// if(instance.get(DistributionMongoDBObject.SUCCESSFULLY_DOWNLOADED).toString()
	// == "true"){
	...
	// instance.get(DistributionMongoDBObject.LAST_ERROR_MSG).toString()+"</span>";
	// //
	// // }
	// str = str + "</tr></td>";
	// }
