...
public class PredicateMongoDBObject extends DBSuperClass {

	public static final String COLLECTION_NAME = "Predicate";

	public static final String DYN_LOD_ID = "dynLodID";

	private int dynLodID = 0;

	public PredicateMongoDBObject(int id) {
		super(COLLECTION_NAME, id);
		loadObject();
	}

	public PredicateMongoDBObject(String URI) {
